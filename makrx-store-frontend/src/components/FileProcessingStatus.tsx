  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-4">
      <div className="flex items-center justify-between mb-4">
        <h4 className="text-sm font-medium text-gray-900">Processing {fileName}</h4>
              ...
              <div className="ml-3">
                ...
                {isCurrent && (
                  <p className="text-xs text-blue-600">
                    {step.key === 'analyzing' ? 'Analyzing geometry...' :
                     step.key === 'calculating' ? 'Calculating materials and time...' :
                     'In progress...'}
                  </p>
                )}
              </div>
      ...
      {result && (
        <div className="mt-4 pt-4 border-t border-gray-200">
          <h5 className="text-sm font-medium text-gray-900 mb-2">Quote Summary</h5>
