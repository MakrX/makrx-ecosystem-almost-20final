    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Upload & Quote</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Upload your 3D models and get instant quotes from our network of verified makers. 
            Professional quality, competitive pricing, fast turnaround.
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              >
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {isDragActive ? 'Drop files here' : 'Drag & drop your 3D files'}
                </h3>
                ...
                {materials.map((material) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 text-xs font-medium rounded-full ${material.color}`}>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      {processingCount} file{processingCount > 1 ? 's' : ''} being analyzed...
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div key={file.id} className="p-4">
                      ...
                      <div className="flex items-center text-sm">
                        ...
                        <span className={`${
                          ...
                          {file.status === 'processing' && 'Generating quote...'}
                        </span>
                      </div>
                        ...
                        <div className="mt-3 p-3 bg-gray-50 rounded-lg">
                          <div className="grid grid-cols-2 gap-2 text-xs">
                            <div className="flex items-center">
                              ...
                              <span className="font-medium">${file.quote.price}</span>
                            </div>
                            <div className="flex items-center">
