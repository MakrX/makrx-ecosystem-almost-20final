          ...
          <div className="p-8">
              ...
              <div className="space-y-6">
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Our most popular shipping option. Reliable delivery with
                    tracking included. Perfect for non-urgent orders and bulk
                    purchases.
                  </p>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Faster delivery for when you need your materials sooner.
                    Includes priority handling and expedited processing.
                  </p>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Emergency delivery for urgent projects. Orders must be
                    placed by 2 PM EST for next business day delivery.
                  </p>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Pick up your order from our warehouse or partner locations.
                    Perfect for large or fragile items. Available in major
                    metropolitan areas.
                  </p>
                </div>
              </div>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li>
                    • <strong>Custom colors/specifications:</strong> 2-3
                    business days
                  </li>
                  <li>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li>
                    • <strong>Rush orders:</strong> 24-48 hours (additional fees
                    apply)
                  </li>
                </ul>
              </div>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-yellow-400 pl-6">
                  ...
                  <p className="text-gray-600">
                    Certain resins and chemicals require special handling and
                    may have shipping restrictions. Ground shipping only for
                    hazmat items. Additional fees and extended processing time
                    apply.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-blue-400 pl-6">
                  ...
                  <p className="text-gray-600">
                    3D printers and large equipment ship via freight. We'll
                    contact you to schedule delivery. White glove delivery
                ...
                <div className="border-l-4 border-purple-400 pl-6">
                  ...
                  <p className="text-gray-600">
                    Detailed 3D prints and delicate materials receive extra
                    protective packaging. Signature confirmation required for
                    deliveries over $200.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Track your order from processing to delivery with our
                      real-time tracking system. You'll receive email and SMS
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="text-gray-600 mb-4">
                  Questions about shipping? Our customer service team is here to
                  help.
                </p>
