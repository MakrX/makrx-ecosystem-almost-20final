          ...
          <div className="p-8">
            ...
            <section className="mb-12">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      At MakrX Store, we are committed to protecting your privacy and ensuring the security
                      of your personal information. This policy explains how we collect, use, share, and
              ...
              <div className="prose max-w-none text-gray-600">
                <p>
                  This privacy policy applies to all information collected through our website, mobile
                  applications, and any related services, sales, marketing, or events (collectively,
                  the "Services").
                </p>
              </div>
            </section>
              ...
              <div className="space-y-6">
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Information you provide directly when creating an account or making a purchase:
                  </p>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">3D Printing Files</h3>
                  </div>
                  <p className="text-gray-600 mb-4">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-900">Security & Legal</h3>
                  <ul className="space-y-2 text-gray-600">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm">
                      ...
                      their marketing purposes. Your data is only shared in specific circumstances
                      outlined below.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-purple-400 pl-6">
                  ...
                  <p className="text-gray-600">
                    ...
                    may be transferred as part of the business transaction. We will notify you
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Access & Update</h3>
                    <p className="text-gray-600 text-sm mb-3">
                      View and modify your personal information through your account settings.
                    </p>
                    <Link href="/account/settings" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                      Account Settings →
                    </Link>
                  </div>

                  <div className="border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Delete Account</h3>
                    <p className="text-gray-600 text-sm mb-3">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-blue-900 mb-3">California Privacy Rights (CCPA)</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Required for basic website functionality, such as maintaining your shopping
                        cart and keeping you logged in.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Help us understand how visitors use our website so we can improve the
                        user experience.
                      </p>
                    </div>
            ...
            <section className="mb-12">
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Data Transfers</h3>
                    <p className="text-gray-600 mb-4">
                      MakrX Store operates primarily in the United States. If you are located outside
                      the US, your information may be transferred to and processed in the United States
                      where our servers and business operations are located.
                    </p>
                    
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-medium text-gray-900 mb-1">GDPR Compliance (EU Users)</h4>
                        <p className="text-sm text-gray-600">
                          We comply with GDPR requirements for European users, including lawful basis
                          for processing and enhanced user rights.
                        </p>
                      </div>
                      
                      <div>
                        <h4 className="font-medium text-gray-900 mb-1">Adequate Protection</h4>
                        <p className="text-sm text-gray-600">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Privacy Officer</h3>
                    <p className="text-sm text-gray-600 mb-1">Email: privacy@makrx.store</p>
