  ...
  const values = [
    {
      ...
      description:
        "Everything we do is centered around empowering our maker community",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "We constantly push the boundaries of what's possible in manufacturing",
    },
    {
      icon: Heart,
      title: "Quality",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              MakrX is more than a marketplace – we're the bridge between
              imagination and reality, connecting creators with the tools,
              services, and community they need to build the future.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                ...
                knowledge needed to bring their ideas to life. From hobbyists to
                enterprises, we're democratizing manufacturing and empowering
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Making advanced manufacturing accessible to creators
                      worldwide
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Curating only the best tools and services for our
                      community
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Building connections between makers across the globe
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of makers who are already building the future with
            MakrX
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
