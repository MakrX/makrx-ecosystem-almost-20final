...
To exercise these rights, contact us at privacy@makrx.store.`
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Related Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/terms" className="bg-white p-6 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all text-center group">
              <FileText className="h-8 w-8 text-gray-400 group-hover:text-blue-600 mx-auto mb-3" />
              <h4 className="font-semibold text-gray-900 group-hover:text-blue-600 mb-2">Terms of Service</h4>
              <p className="text-sm text-gray-600">Our terms and conditions</p>
            </Link>
            <Link href="/cookies" className="bg-white p-6 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all text-center group">
              <Eye className="h-8 w-8 text-gray-400 group-hover:text-blue-600 mx-auto mb-3" />
              <h4 className="font-semibold text-gray-900 group-hover:text-blue-600 mb-2">Cookie Policy</h4>
              <p className="text-sm text-gray-600">How we use cookies</p>
            </Link>
            <Link href="/security" className="bg-white p-6 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all text-center group">
              <Lock className="h-8 w-8 text-gray-400 group-hover:text-blue-600 mx-auto mb-3" />
              <h4 className="font-semibold text-gray-900 group-hover:text-blue-600 mb-2">Security</h4>
