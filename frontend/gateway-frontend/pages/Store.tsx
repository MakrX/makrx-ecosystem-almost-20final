...
const featuredProducts: Product[] = [
  {
    ...
    featured: true,
    description:
      "Personalized phone case with custom design and premium materials",
  },
  {
    id: "2",
    ...
    featured: true,
    description:
      "Elegant bamboo desk organizer with precision laser-cut compartments",
  },
  {
    id: "3",
...
const services: Service[] = [
  {
    ...
    description:
      "Upload your STL files and get professional 3D prints delivered",
    icon: Upload,
    price: "From $5",
    turnaround: "2-5 days",
    features: [
      "PLA, ABS, PETG materials",
      "Layer heights from 0.1mm",
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            The ultimate marketplace for custom manufacturing, 3D printing
            services, and maker-created products with global delivery.
          </p>
        </div>
        ...
        <div className="mb-12">
          <div className="makrx-glass-card max-w-2xl mx-auto text-center">
            <h2 className="text-2xl font-bold mb-4">
              Upload & Print in Minutes
            </h2>
            <p className="text-muted-foreground mb-6">
              Upload your 3D model and get instant pricing with material options
            ...
            {!isAuthenticated && (
              <p className="text-sm text-muted-foreground">
                <Link to="/login" className="text-makrx-yellow hover:underline">
                  Sign in
                </Link>{" "}
                to upload files and get instant quotes
              </p>
            )}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="makrx-glass-card hover:scale-105 transition-transform"
                >
                  <div
                    className={`w-16 h-16 bg-${service.color}/20 rounded-xl flex items-center justify-center mb-4 mx-auto`}
                  >
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              to="#"
              className="text-makrx-yellow hover:text-makrx-yellow/80 flex items-center gap-2"
            >
              View All Products
          ...
          <div className="makrx-glass-card">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold mb-4">
                Why Choose MakrX Store?
              </h2>
              <p className="text-muted-foreground">
                Global manufacturing network with intelligent automation and
                quality guarantee
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Connected to 500+ manufacturers worldwide for fastest delivery
                  and best pricing
                </p>
              </div>
              <div className="text-center p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  AI-powered pricing engine considers material, complexity, and
                  local availability
                </p>
              </div>
              <div className="text-center p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Every order backed by our quality guarantee and expert quality
                  control
                </p>
              </div>
            </div>
            ...
            <div className="text-center mt-8">
              {isAuthenticated ? (
                ...
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Join thousands of makers who trust MakrX for their
                    manufacturing needs
                  </p>
                  <div className="space-x-4">
