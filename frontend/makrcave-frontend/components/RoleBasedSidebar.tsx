...
function ServiceProviderSidebar() {
  ...
  return (
    <div className="makrcave-sidebar bg-gradient-to-b from-yellow-900/20 to-yellow-800/10 border-r border-yellow-200">
      {/* Logo & Title */}
      <div className="p-4 sm:p-6 border-b border-yellow-200 flex-shrink-0">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-yellow-600 to-yellow-700 rounded-lg flex items-center justify-center">
            <Settings className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
          </div>
          <div className="min-w-0">
            <h2 className="font-bold text-base sm:text-lg text-yellow-700 truncate">Service Provider</h2>
            <p className="text-xs text-yellow-600 truncate">Currently Restricted</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 sm:p-4 border-b border-yellow-200 flex-shrink-0">
        <Link
          to="/portal/profile"
          className="flex items-center gap-2 sm:gap-3 hover:bg-yellow-100 rounded-lg p-2 -m-2 transition-colors group"
        >
          <div className="w-7 h-7 sm:w-8 sm:h-8 bg-yellow-100 rounded-full flex items-center justify-center group-hover:bg-yellow-200 transition-colors flex-shrink-0">
      ...
      <div className="flex-1 p-3 sm:p-4 overflow-y-auto">
        <div className="p-3 sm:p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <h3 className="text-xs sm:text-sm font-semibold text-yellow-800 mb-2">Account Restricted</h3>
      ...
      {/* Logout */}
      <div className="p-3 sm:p-4 border-t border-yellow-200 flex-shrink-0">
        <button
          onClick={logout}
          className="flex items-center gap-2 sm:gap-3 w-full px-2 sm:px-3 py-2 text-xs sm:text-sm font-medium text-gray-700 hover:text-yellow-700 hover:bg-yellow-50 rounded-lg transition-colors"
        >
          <LogOut className="w-4 h-4 flex-shrink-0" />
          <span className="truncate">Sign Out</span>
        </button>
